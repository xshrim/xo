...
#COPY --from=builder /go/bin/gogit /usr/local/bin/git
...
# add helm-push
#RUN helm plugin install https://github.com/chartmuseum/helm-push && rm -rf /tmp/helm-* /root/.local/share/helm/plugins/helm-push/testdata root/.cache/helm/plugins/https-github.com-chartmuseum-helm-push/testdata
